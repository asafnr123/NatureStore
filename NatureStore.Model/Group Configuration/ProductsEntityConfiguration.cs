        ...
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                new Product
                {
                    ...
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Protein1.jpg"
                },
                ...
                new Product
                {
                    ...
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Protein3.jpg"
                },
                ...
                new Product
                {
                    ...
                    Brand = "Optimum Nutrition",
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Protein4.jpg"
                },
                ...
                new Product
                {
                    ...
                    Brand = "Optimum Nutrition",
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Protein5.jpg"
                },
                ...
                new Product
                {
                    ...
                    Brand = "California Gold Nutrition",
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Vitamin1.jpg"
                },
                ...
                new Product
                {
                    ...
                    Brand = "Sahale Snacks",
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Snack1.jpg"
                },
                ...
                new Product
                {
                    ...
                    Brand = "Sahale Snacks",
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Snack2.jpg"
                },
                ...
                new Product
                {
                    ...
                    Brand = "California Gold Nutrition",
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Snack3.jpg"
                },
                ...
                new Product
                {
                    ...
                    Brand = "California Gold Nutrition",
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Snack4.jpg"
                },
                ...
                new Product
                {
                    ...
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Vitamin2.jpg"
                },
                ...
                new Product
                {
                    ...
                    Brand = "California Gold Nutrition",
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Vitamin3.jpg"
                },
                ...
                new Product
                {
                    ...
                    Brand = "YumV's",
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Vitamin4.jpg"
                },
                ...
                new Product
                {
                    ...
                    Brand = "Pure Synergy",
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Vitamin5.jpg"
                },
                ...
                new Product
                {
                    ...
                    Brand = "Sunwarrior",
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Creatine1.jpg"
                },
                ...
                new Product
                {
                    ...
                    Brand = "MuscleTech",
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Creatine2.jpg"
                },
                ...
                new Product
                {
                    ...
                    Brand = "Optimum Nutrition",
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Creatine3.jpg"
                },
                ...
                new Product
                {
                    ...
                    Image = $@"{projectPath}" + @"\Pages\ProductsDropMenu\Pictures\Creatine4.jpg"
                }
